...
fn run_part1() {
    let actual = part1("src/day1/input.txt");
    io::write_to_file("src/day1/part1_output.txt", actual);
}
...
fn run_part2() {
    let actual = part2("src/day1/input.txt");
    io::write_to_file("src/day1/part2_output.txt", actual);
}
